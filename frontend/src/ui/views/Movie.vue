<template>
  ...
  <div class="border border-gray-300 p-4 max-w-4xl min-w-1/2 mx-auto bg-white rounded-md flex flex-col justify-between h-screen sm:h-fit w-full" v-else-if="movie?.title">
    <div>
